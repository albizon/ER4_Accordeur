...
{
	vect[3] = reallocMemory(vect[3], vect[1]*vect[2], vect[1]*haveImag, vect[0]);
	vect[2]=haveImag;
}
...
{
	return readMemory((vect[3]+vect[1]+i), vect[0]);
}
...
{
	float imag = readMemory((vect[3]+vect[1]+i), vect[0]);
	float real = readMemory((vect[3]+i), vect[0]);
